...
class GroupRepositoryImpl implements GroupRepository {
  ...
  static String _messageFor(PostgrestException error) {
    ...
    // RPC-raised domain errors (create_ride_group / join_group_by_code /
    // leave_group) all surface as Postgres' generic P0001 "raised
    // exception" code — match on the message text itself instead.
